      ...
      <section className="w-full px-4 md:px-6 pb-14 md:pb-20">
        ...
        >
          ...
          >
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              <p style={{ fontSize: 22, fontWeight: 600, color: "#141414", lineHeight: "30px" }}>
                Налаштування і адаптація
              </p>
              <p style={{ fontSize: 13, color: "#6b7280", lineHeight: "21px" }}>
                Наша команда налаштує систему під ваші бізнес-процеси.
            ...
            <div style={{ paddingTop: 20 }}>
              <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 4 }}>
                <span style={{ fontSize: 16, fontWeight: 500, color: "#9ca3af" }}>від</span>
                <span style={{ fontSize: 34, fontWeight: 600, color: "#141414", lineHeight: 1, letterSpacing: "-0.02em", marginLeft: 4 }}>
                  $300
                </span>
                <span style={{ fontSize: 13, color: "#9ca3af", marginLeft: 2 }}> / блок</span>
              </div>
              <p style={{ fontSize: 12, color: "#b0b7c3", marginBottom: 20 }}>
                разова оплата
              </p>
